...
namespace DataAccess
{
    public interface IDataAccess
    {
        ...
        Task<IEnumerable<T>> QueryAsync<T>(string sql, object? parameters=null , string? connectionId=null  , CommandType? commandType=null );
        ...
        Task<dynamic> QueryAsyncDynamic(string sql, object? parameters=null, string? connectionId=null  , CommandType? commandType = null );
